    ...
    >
      ...
      <div>
        ...
        <input
          ...
          id="password"
          placeholder="••••••••"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 <?php echo (!empty($data['password_err'])) ? 'border-red-500' : ''; ?>"
        />
        <p class="text-xs italic text-red-500">
        </p>
      </div>
